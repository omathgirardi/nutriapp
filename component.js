...
\u{1F4CE} PDF detalhado ser\xE1 enviado separadamente`;
  ...
  const generateDiet = async () => {
    try {
      ...
      if (calculatorData.clientId) {
        ...
        if (!clientData) {
          alert("Cliente n\xE3o encontrado!");
  ...
  const generateDietPDF = async (diet, forEmail = false) => {
    try {
      ...
      alert("Erro ao gerar PDF. Verifique sua conex\xE3o e tente novamente.");
    }
  };
    ...
    try {
      ...
      if (!clientEmail) {
        ...
        if (!clientEmail || clientEmail.trim() === "") {
          alert("\u274C Email \xE9 obrigat\xF3rio para enviar por email!");
          return;
        }
        const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
        if (!emailRegex.test(clientEmail)) {
          alert("\u274C Por favor, digite um email v\xE1lido!");
          return;
        }
      }
      const date = new Date(diet.createdAt);
...
\u26A0\uFE0F Este plano foi desenvolvido especificamente para voc\xEA.`;
  ...
  const handleLogin = (e) => {
    ...
    if (loginData.email === "admin@nutriapp.com") {
      ...
      setCurrentUser({ id: "P0001", name: "Jo\xE3o Silva", email: loginData.email });
  ...
  const handlePhotoUpload = (event) => {
    ...
    if (file.size > 5 * 1024 * 1024) {
      alert("A imagem deve ter no m\xE1ximo 5MB!");
      return;
    }
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gray-50 flex" }, userRole === "personal" && /* @__PURE__ */ React.createElement("div", { className: "fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 lg:hidden z-40" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-6 h-16" }, personalMenuItems.map((item) => /* @__PURE__ */ React.createElement(
    ...
    item.label
  ))), /* @__PURE__ */ React.createElement("div", { className: "absolute bottom-0 w-full p-6 border-t border-gray-200" }, userRole === "personal" && /* @__PURE__ */ React.createElement("div", { className: "mb-4 p-3 bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-lg" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center" }, /* @__PURE__ */ React.createElement(AlertCircle, { className: "text-orange-600", size: 16 })), /* @__PURE__ */ React.createElement("div", { className: "flex-1" }, /* @__PURE__ */ React.createElement("h4", { className: "text-sm font-semibold text-orange-900" }, "Cr\xE9ditos Baixos!"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-orange-700" }, "Apenas ", /* @__PURE__ */ React.createElement("strong", null, "5 cr\xE9ditos"), " restantes."))), /* @__PURE__ */ React.createElement(
    Button,
    {
      size: "sm",
    ...
    "Recarregar Agora"
  )), /* @__PURE__ */ React.createElement("div", { className: "flex items-center mb-4" }, /* @__PURE__ */ React.createElement("div", { className: `w-10 h-10 rounded-full flex items-center justify-center mr-3 overflow-hidden ${!(profilePhoto || currentUser.photo) ? `bg-[${colors.primary[600]}]` : ""}` }, profilePhoto || currentUser.photo ? /* @__PURE__ */ React.createElement(
    "img",
    {
    ...
    "Sair"
  ))), /* @__PURE__ */ React.createElement("div", { className: "flex-1 lg:ml-0" }, /* @__PURE__ */ React.createElement("div", { className: "hidden" }), /* @__PURE__ */ React.createElement("main", { className: "p-4 md:p-6 pb-20 lg:pb-6 pt-4" }, activeSection === "dashboard" && /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, userRole === "admin" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-gray-500 text-sm mb-6" }, "Aqui est\xE1 um resumo da sua atividade hoje")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6" }, /* @__PURE__ */ React.createElement(Card, { className: "p-4 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xl md:text-2xl font-bold text-gray-900" }, clients.length || 0), /* @__PURE__ */ React.createElement("p", { className: "text-gray-500 text-sm mb-2" }, "Clientes Cadastrados"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "text-gray-600 bg-gray-50 px-2 py-1 rounded-full whitespace-nowrap" }, "Dados reais do Firebase"))), /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-blue-50 rounded-xl flex items-center justify-center flex-shrink-0 ml-3" }, /* @__PURE__ */ React.createElement(Users, { className: "text-blue-600", size: 20 })))), /* @__PURE__ */ React.createElement(Card, { className: "p-4 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xl md:text-2xl font-bold text-gray-900" }, diets.length || 0), /* @__PURE__ */ React.createElement("p", { className: "text-gray-500 text-sm mb-2" }, "Dietas Geradas"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "text-gray-600 bg-gray-50 px-2 py-1 rounded-full whitespace-nowrap" }, "Dados reais do Firebase"))), /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-green-50 rounded-xl flex items-center justify-center flex-shrink-0 ml-3" }, /* @__PURE__ */ React.createElement(FileText, { className: "text-green-600", size: 20 })))), /* @__PURE__ */ React.createElement(Card, { className: "p-4 md:p-6 sm:col-span-2 lg:col-span-1" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xl md:text-2xl font-bold text-gray-900" }, clients.length > 0 ? Math.round((clients.filter(c => c.status === 'ativo').length / clients.length) * 100) : 0, "%"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-500 text-sm mb-2" }, "Taxa de Sucesso"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "text-gray-600 bg-gray-50 px-2 py-1 rounded-full whitespace-nowrap" }, "Baseado em clientes ativos"))), /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-emerald-50 rounded-xl flex items-center justify-center flex-shrink-0 ml-3" }, /* @__PURE__ */ React.createElement(TrendingUp, { className: "text-emerald-600", size: 20 }))))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6" }, /* @__PURE__ */ React.createElement(Card, { className: "p-4 md:p-6 lg:col-span-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4 md:mb-6" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold text-gray-900" }, "Top Personal Trainers"), /* @__PURE__ */ React.createElement("span", { className: "text-sm text-gray-500" }, "Este m\xEAs")), /* @__PURE__ */ React.createElement("div", { className: "space-y-3 md:space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-3 md:p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3 md:space-x-4 min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0 bg-yellow-100" }, profilePhoto || currentUser.photo ? /* @__PURE__ */ React.createElement(
    "img",
    {
      src: profilePhoto || currentUser.photo,
      alt: "Jo\xE3o Silva",
  ...
  ) : /* @__PURE__ */ React.createElement(Crown, { className: "text-yellow-600", size: 20 })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h4", { className: "font-semibold text-gray-900 text-sm md:text-base truncate" }, "Jo\xE3o Silva"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-600" }, "Personal Trainer"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2 mt-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full whitespace-nowrap" }, "127 dietas"), /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full whitespace-nowrap" }, "45 clientes")))), /* @__PURE__ */ React.createElement("div", { className: "text-right flex-shrink-0 ml-2" }, /* @__PURE__ */ React.createElement("p", { className: "text-xl md:text-2xl font-bold text-yellow-600" }, "#1"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-500" }, "L\xEDder")))), /* @__PURE__ */ React.createElement("div", { className: "bg-gray-50 rounded-xl p-3 md:p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3 md:space-x-4 min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-gray-100 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(User, { className: "text-gray-600", size: 20 })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h4", { className: "font-semibold text-gray-900 text-sm md:text-base truncate" }, "Maria Santos"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-600" }, "Personal Trainer"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2 mt-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full whitespace-nowrap" }, "98 dietas"), /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full whitespace-nowrap" }, "32 clientes")))), /* @__PURE__ */ React.createElement("div", { className: "text-right flex-shrink-0 ml-2" }, /* @__PURE__ */ React.createElement("p", { className: "text-xl md:text-2xl font-bold text-gray-600" }, "#2"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-500" }, "Vice-l\xEDder")))), /* @__PURE__ */ React.createElement("div", { className: "bg-gray-50 rounded-xl p-3 md:p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3 md:space-x-4 min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-gray-100 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(User, { className: "text-gray-600", size: 20 })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h4", { className: "font-semibold text-gray-900 text-sm md:text-base truncate" }, "Carlos Oliveira"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-600" }, "Personal Trainer"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2 mt-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full whitespace-nowrap" }, "87 dietas"), /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full whitespace-nowrap" }, "28 clientes")))), /* @__PURE__ */ React.createElement("div", { className: "text-right flex-shrink-0 ml-2" }, /* @__PURE__ */ React.createElement("p", { className: "text-xl md:text-2xl font-bold text-gray-600" }, "#3"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-500" }, "3\xBA lugar")))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3 md:gap-4 mt-4 md:mt-6" }, /* @__PURE__ */ React.createElement("div", { className: "bg-blue-50 p-3 md:p-4 rounded-lg text-center" }, /* @__PURE__ */ React.createElement("p", { className: "text-xl md:text-2xl font-bold text-blue-600" }, "312"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-600" }, "Total de Dietas")), /* @__PURE__ */ React.createElement("div", { className: "bg-green-50 p-3 md:p-4 rounded-lg text-center" }, /* @__PURE__ */ React.createElement("p", { className: "text-xl md:text-2xl font-bold text-green-600" }, "105"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-600" }, "Total de Clientes"))))), /* @__PURE__ */ React.createElement(Card, { className: "p-4 md:p-6" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold text-gray-900 mb-4 md:mb-6" }, "Atividade Recente"), /* @__PURE__ */ React.createElement("div", { className: "space-y-3 md:space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start space-x-3 p-3 bg-blue-50 rounded-lg" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(User, { size: 16, className: "text-blue-600" })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("p", { className: "font-medium text-gray-900 text-sm truncate" }, "Maria Silva"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "2 horas atr\xE1s \u2022 1800 kcal"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-start space-x-3 p-3 bg-emerald-50 rounded-lg" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(DollarSign, { size: 16, className: "text-emerald-600" })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("p", { className: "font-medium text-gray-900 text-sm" }, "Venda nova - Jo\xE3o comprou 500 cr\xE9ditos"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "1 dia atr\xE1s"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-start space-x-3 p-3 bg-blue-50 rounded-lg" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(User, { size: 16, className: "text-blue-600" })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("p", { className: "font-medium text-gray-900 text-sm truncate" }, "Ana Costa"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "2 dias atr\xE1s \u2022 2000 kcal"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-start space-x-3 p-3 bg-blue-50 rounded-lg" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(Star, { size: 16, className: "text-blue-600" })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("p", { className: "font-medium text-gray-900 text-sm" }, "Conquista desbloqueada: 50 Dietas"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "3 dias atr\xE1s"))))))) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-gray-500 text-sm mb-6" }, "Aqui est\xE1 um resumo da sua atividade hoje")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6" }, /* @__PURE__ */ React.createElement(Card, { className: "p-4 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xl md:text-2xl font-bold text-gray-900" }, "23"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-500 text-sm mb-2" }, "Alunos Cadastrados"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "text-green-600 bg-green-50 px-2 py-1 rounded-full whitespace-nowrap" }, "+3 este m\xEAs"))), /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-blue-50 rounded-xl flex items-center justify-center flex-shrink-0 ml-3" }, /* @__PURE__ */ React.createElement(Users, { className: "text-blue-600", size: 20 })))), /* @__PURE__ */ React.createElement(Card, { className: "p-4 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xl md:text-2xl font-bold text-gray-900" }, "187"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-500 text-sm mb-2" }, "Receitas Geradas"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "text-green-600 bg-green-50 px-2 py-1 rounded-full whitespace-nowrap" }, "+15 esta semana"))), /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-green-50 rounded-xl flex items-center justify-center flex-shrink-0 ml-3" }, /* @__PURE__ */ React.createElement(FileText, { className: "text-green-600", size: 20 })))), /* @__PURE__ */ React.createElement(
    Card,
    {
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xl md:text-2xl font-bold text-orange-600" }, "5"), /* @__PURE__ */ React.createElement("p", { className: "text-orange-700 text-sm mb-2" }, "Cr\xE9ditos Restantes"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "text-red-600 bg-red-100 px-2 py-1 rounded-full whitespace-nowrap animate-pulse" }, "\u26A0\uFE0F Cr\xE9ditos baixos"))), /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-orange-100 rounded-xl flex items-center justify-center flex-shrink-0 ml-3" }, /* @__PURE__ */ React.createElement(AlertCircle, { className: "text-orange-600", size: 20 })))
  ), /* @__PURE__ */ React.createElement(Card, { className: "p-4 md:p-6 bg-gradient-to-br from-emerald-50 to-green-50 border-emerald-200 sm:col-span-2 xl:col-span-1" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg md:text-xl font-bold text-emerald-800" }, "Expert"), /* @__PURE__ */ React.createElement("p", { className: "text-emerald-600 text-sm mb-3" }, "Gere 100 dietas"), /* @__PURE__ */ React.createElement("div", { className: "w-full bg-emerald-100 rounded-full h-2 mb-2" }, /* @__PURE__ */ React.createElement("div", { className: "bg-emerald-500 h-2 rounded-full", style: { width: "86%" } })), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-xs text-emerald-600" }, /* @__PURE__ */ React.createElement("span", null, "86/100"), /* @__PURE__ */ React.createElement("span", null, "86%"))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-end flex-shrink-0 ml-3" }, /* @__PURE__ */ React.createElement("div", { className: "text-xs text-emerald-600 font-medium mb-2" }, "Pr\xF3xima"), /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-emerald-100 rounded-xl flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Award, { className: "text-emerald-600", size: 20 })))))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6" }, /* @__PURE__ */ React.createElement(Card, { className: "p-4 md:p-6 lg:col-span-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 md:mb-6" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold text-gray-900" }, "Meus Clientes"), /* @__PURE__ */ React.createElement(Button, { size: "sm", onClick: () => setShowAddClientModal(true), className: "w-full sm:w-auto" }, /* @__PURE__ */ React.createElement(Plus, { size: 16 }), "Novo Cliente")), /* @__PURE__ */ React.createElement("div", { className: "space-y-3 md:space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-3 md:p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3 md:space-x-4 min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-green-100 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(User, { className: "text-green-600", size: 20 })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h4", { className: "font-semibold text-gray-900 text-sm md:text-base" }, "Ana Costa"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-600" }, "28 anos \u2022 65kg \u2022 Perda de peso"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "Frequ\xEAncia: 4x por semana"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2 mt-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full whitespace-nowrap" }, "1800 kcal"), /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full whitespace-nowrap" }, "Ativa")))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-end w-full sm:w-auto" }, /* @__PURE__ */ React.createElement(
    Button,
    {
      size: "sm",
  ...
  )))), /* @__PURE__ */ React.createElement("div", { className: "bg-gray-50 rounded-xl p-3 md:p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3 md:space-x-4 min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-gray-100 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(User, { className: "text-gray-600", size: 20 })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h4", { className: "font-semibold text-gray-900 text-sm md:text-base" }, "Pedro Lima"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-600" }, "35 anos \u2022 80kg \u2022 Ganho de massa"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "Frequ\xEAncia: 5x por semana"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2 mt-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full whitespace-nowrap" }, "2500 kcal"), /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full whitespace-nowrap" }, "Ativo")))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-end w-full sm:w-auto" }, /* @__PURE__ */ React.createElement(Button, { size: "sm", className: "w-full sm:w-auto" }, /* @__PURE__ */ React.createElement(FileText, { size: 14 }), /* @__PURE__ */ React.createElement("span", { className: "ml-1" }, "Nova Dieta"))))), /* @__PURE__ */ React.createElement("div", { className: "bg-gray-50 rounded-xl p-3 md:p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3 md:space-x-4 min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 md:w-12 md:h-12 bg-gray-100 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(User, { className: "text-gray-600", size: 20 })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h4", { className: "font-semibold text-gray-900 text-sm md:text-base" }, "Julia Rodrigues"), /* @__PURE__ */ React.createElement("p", { className: "text-xs md:text-sm text-gray-600" }, "42 anos \u2022 70kg \u2022 Manuten\xE7\xE3o"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "Frequ\xEAncia: 3x por semana"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2 mt-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full whitespace-nowrap" }, "2000 kcal"), /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-orange-100 text-orange-700 px-2 py-1 rounded-full whitespace-nowrap" }, "Pausada")))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-end w-full sm:w-auto" }, /* @__PURE__ */ React.createElement(Button, { size: "sm", className: "w-full sm:w-auto" }, /* @__PURE__ */ React.createElement(FileText, { size: 14 }), /* @__PURE__ */ React.createElement("span", { className: "ml-1" }, "Nova Dieta"))))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-3 md:gap-4 mt-4 md:mt-6" }, /* @__PURE__ */ React.createElement("div", { className: "bg-blue-50 p-2 md:p-3 rounded-lg text-center" }, /* @__PURE__ */ React.createElement("p", { className: "text-lg md:text-xl font-bold text-blue-600" }, "23"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-600" }, "Total Clientes")), /* @__PURE__ */ React.createElement("div", { className: "bg-green-50 p-2 md:p-3 rounded-lg text-center" }, /* @__PURE__ */ React.createElement("p", { className: "text-lg md:text-xl font-bold text-green-600" }, "18"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-600" }, "Ativos")), /* @__PURE__ */ React.createElement("div", { className: "bg-orange-50 p-2 md:p-3 rounded-lg text-center" }, /* @__PURE__ */ React.createElement("p", { className: "text-lg md:text-xl font-bold text-orange-600" }, "5"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-600" }, "Pausados"))))), /* @__PURE__ */ React.createElement(Card, { className: "p-4 md:p-6" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold text-gray-900 mb-4 md:mb-6" }, "Atividade Recente"), /* @__PURE__ */ React.createElement("div", { className: "space-y-3 md:space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start space-x-3 p-3 bg-green-50 rounded-lg" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(FileText, { size: 16, className: "text-green-600" })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("p", { className: "font-medium text-gray-900 text-sm truncate" }, "Ana Costa"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "2 horas atr\xE1s \u2022 1800 kcal"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-start space-x-3 p-3 bg-blue-50 rounded-lg" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(Users, { size: 16, className: "text-blue-600" })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("p", { className: "font-medium text-gray-900 text-sm" }, "Novo cliente: Maria Silva"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "1 dia atr\xE1s"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-start space-x-3 p-3 bg-green-50 rounded-lg" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(FileText, { size: 16, className: "text-green-600" })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("p", { className: "font-medium text-gray-900 text-sm truncate" }, "Pedro Lima"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "2 dias atr\xE1s \u2022 2500 kcal"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-start space-x-3 p-3 bg-emerald-50 rounded-lg" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 bg-emerald-100 rounded-full flex items-center justify-center flex-shrink-0" }, /* @__PURE__ */ React.createElement(Award, { size: 16, className: "text-emerald-600" })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("p", { className: "font-medium text-gray-900 text-sm" }, "Conquista: Mentor desbloqueada!"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "3 dias atr\xE1s")))))))), activeSection === "calculator" && /* @__PURE__ */ React.createElement("div", { className: "space-y-4 md:space-y-6 pb-20 lg:pb-6" }, /* @__PURE__ */ React.createElement(Card, { className: "p-3 md:p-6" }, /* @__PURE__ */ React.createElement("h2", { className: "text-base md:text-xl font-semibold text-gray-900 mb-3 md:mb-6" }, "Gerador de Dietas"), /* @__PURE__ */ React.createElement("div", { className: "space-y-3 md:space-y-4 mb-4 md:mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col space-y-2 md:flex-row md:items-center md:space-y-0 md:space-x-4" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm md:text-md font-medium text-gray-900" }, "Selecionar Cliente:"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2 md:flex md:space-x-2" }, /* @__PURE__ */ React.createElement(
    Button,
    {
      size: "sm",
      variant: "outline",
...
\u{1F4A1} Considere desativar ao inv\xE9s de excluir se houver depend\xEAncias.`,
    ...
    alert("\u{1F504} Sincroniza\xE7\xE3o iniciada!\n\n\u2705 Base TACO atualizada\n\u2705 Novos alimentos: 47\n\u2705 Corre\xE7\xF5es nutricionais: 12\n\nTempo estimado: 2-3 minutos\nVoc\xEA ser\xE1 notificado quando conclu\xEDdo.");
...
\u{1F504} \xDAltima atualiza\xE7\xE3o: ${(/* @__PURE__ */ new Date()).toLocaleDateString("pt-BR")}`;
    ...
    { name: "Carboidratos", count: foodDatabase && foodDatabase.length > 0 ? foodDatabase.filter(f => f.category === 'carboidratos').length : 0, color: "bg-yellow-100 text-yellow-700" },
    { name: "Prote\xEDnas", count: foodDatabase && foodDatabase.length > 0 ? foodDatabase.filter(f => f.category === 'proteinas').length : 0, color: "bg-red-100 text-red-700" },
    { name: "Gorduras", count: foodDatabase && foodDatabase.length > 0 ? foodDatabase.filter(f => f.category === 'gorduras').length : 0, color: "bg-purple-100 text-purple-700" },
    { name: "Vegetais", count: foodDatabase && foodDatabase.length > 0 ? foodDatabase.filter(f => f.category === 'vegetais').length : 0, color: "bg-green-100 text-green-700" },
    { name: "Frutas", count: foodDatabase && foodDatabase.length > 0 ? foodDatabase.filter(f => f.category === 'frutas').length : 0, color: "bg-orange-100 text-orange-700" },
    { name: "Diversos", count: foodDatabase && foodDatabase.length > 0 ? foodDatabase.filter(f => f.category === 'diversos').length : 0, color: "bg-gray-100 text-gray-700" }
    ...
    "div",
    {
      ...
      onClick: () => {
        showInfoPopup(
          ...
          `\u{1F4CA} Dados din\xE2micos do Firebase:
\u2022 Total de alimentos: ${category.count}
\u2022 Dados atualizados em tempo real
\u2022 Conectado ao Firebase

\u{1F3AF} Esta categoria ser\xE1 populada com dados reais.

\u{1F4A1} Sistema pronto para uso!`,
          "info"
        );
      }
    },
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-2" }, /* @__PURE__ */ React.createElement("span", { className: `text-sm px-2 py-1 rounded-full ${category.color}` }, category.count, " itens"), /* @__PURE__ */ React.createElement("div", { className: "w-20 bg-gray-200 rounded-full h-2" }, /* @__PURE__ */ React.createElement(
      "div",
      {
        ...
        style: { width: `${Math.max(category.count, 1) / Math.max(847, 623, 412, 534, 289, 142, 1) * 100}%` }
      }
    )))
    ...
    { action: "Base de dados ativa", item: `${foodDatabase.length} alimentos carregados`, time: "Agora", type: "sync" } :
    { action: "Sistema iniciado", item: "Aguardando dados do Firebase", time: "Agora", type: "add" }
    ...
    e.preventDefault();
    alert("\u{1F4E7} Configura\xE7\xF5es de email salvas!\n\n\u2705 SMTP configurado\n\u2705 Templates atualizados\n\u2705 Teste de envio realizado\n\nSeus emails est\xE3o prontos para serem enviados.");
  ...
  )), showSuccessMessage && /* @__PURE__ */ React.createElement("div", { className: "fixed top-4 right-4 z-50" }, /* @__PURE__ */ React.createElement(
    motion.div,
    {
    ...
    Button,
    {
      onClick: () => {
        if (manualDiet.meals.length === 0) {
          alert("Adicione pelo menos uma refei\xE7\xE3o!");
          return;
        }
    ...
    /* @__PURE__ */ React.createElement("div", { className: "text-lg mb-1 group-hover:scale-110 transition-transform" }, "\u2709\uFE0F"),
    /* @__PURE__ */ React.createElement("span", { className: "text-xs text-gray-600 group-hover:text-blue-600" }, "Email")
  ), /* @__PURE__ */ React.createElement(
    Button,
    {
      variant: "outline",
      ...
      onKeyPress: (e) => {
        if (e.key === "Enter") {
          ...
          if (amount > 0) {
            ...
            alert("Por favor, digite uma quantidade v\xE1lida!");
          }
        }
      }
    }
