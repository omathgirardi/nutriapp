...
📎 PDF detalhado será enviado separadamente`;
  ...
  const updateDynamicStats = () => {
    const currentClients = mockClients.length;
    const currentTemplates = mockTemplates.length;
    const currentFoods = foodDatabase.length;
    
    // Simula dados baseados nos dados reais
    const monthlyUsage = Math.floor(currentTemplates * 42 + currentClients * 3.2);
    const totalDiets = Math.floor(currentClients * 6.8 + currentTemplates * 15.3);
    const averageRating = (4.2 + (currentTemplates * 0.1) + (currentClients * 0.02)).toFixed(1);
    const successRate = Math.min(95.8, 85 + (currentClients * 0.08) + (currentTemplates * 0.5)).toFixed(1);
    
    setDashboardStats({
      monthlyUsage: monthlyUsage.toString(),
      averageRating: averageRating,
      personalTrainers: Math.max(1, Math.floor(currentClients / 12)).toString()
    });
    
    setDatabaseStats({
      totalFoods: currentFoods.toLocaleString('pt-BR'),
      totalClients: currentClients.toLocaleString('pt-BR'),
      totalDiets: totalDiets.toLocaleString('pt-BR'),
      successRate: successRate + "%"
    });
  };

  // Atualiza os dados quando o componente monta e quando os dados mudam
  React.useEffect(() => {
    updateDynamicStats();
  }, [mockClients.length, mockTemplates.length, foodDatabase.length]);
...
\u26A0\uFE0F Este plano foi desenvolvido especificamente para voc\xEA.`;
  ...
  const handleLogin = (e) => {
    ...
    if (loginData.email === "admin@nutriapp.com") {
      ...
      setCurrentUser({ id: "P0001", name: registerData.name || "Usuário", email: loginData.email });
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gray-50 flex" }, userRole === "personal" && /* @__PURE__ */ React.createElement("div", { className: "fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 lg:hidden z-40" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-6 h-16" }, personalMenuItems.map((item) => /* @__PURE__ */ React.createElement(
    ...
    "Criar Template"
  ))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4" }, /* @__PURE__ */ React.createElement(Card, { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center" }, /* @__PURE__ */ React.createElement(FileText, { className: "text-blue-600", size: 20 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, mockTemplates.length), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Templates Ativos")))), /* @__PURE__ */ React.createElement(Card, { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center" }, /* @__PURE__ */ React.createElement(TrendingUp, { className: "text-green-600", size: 20 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, dashboardStats.monthlyUsage), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Usos Este M\xEAs")))), /* @__PURE__ */ React.createElement(Card, { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Star, { className: "text-purple-600", size: 20 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, dashboardStats.averageRating), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Avalia\xE7\xE3o M\xE9dia")))), /* @__PURE__ */ React.createElement(Card, { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Users, { className: "text-orange-600", size: 20 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, dashboardStats.personalTrainers), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Personal Trainers"))))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" }, mockTemplates.map((template) => /* @__PURE__ */ React.createElement(Card, { key: template.id, className: "p-6 hover:shadow-lg transition-shadow" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-4 mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "w-12 h-12 bg-green-100 rounded-full flex items-center justify-center" }, /* @__PURE__ */ React.createElement(FileText, { className: "text-green-600", size: 24 })), /* @__PURE__ */ React.createElement("div", { className: "flex-1" }, /* @__PURE__ */ React.createElement("h3", { className: "font-semibold text-gray-900" }, template.name), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, template.meals, " refei\xE7\xF5es")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-end" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full" }, "\u2713 Ativo"))), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600 mb-4 line-clamp-2" }, template.description), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3 mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-center p-2 bg-blue-50 rounded" }, /* @__PURE__ */ React.createElement("p", { className: "text-lg font-bold text-blue-600" }, "127"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-600" }, "Usos")), /* @__PURE__ */ React.createElement("div", { className: "text-center p-2 bg-purple-50 rounded" }, /* @__PURE__ */ React.createElement("p", { className: "text-lg font-bold text-purple-600" }, "4.9"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-600" }, "Avalia\xE7\xE3o"))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2" }, /* @__PURE__ */ React.createElement(
    Button,
    {
      size: "sm",
      variant: "outline",
...
💡 Considere desativar ao inv\xE9s de excluir se houver depend\xEAncias.`,
    ...
    showInfoPopup("📊 Alimentos Cadastrados", `Total: ${databaseStats.totalFoods} alimentos\n\n\u{1F4C8} Crescimento mensal: +${Math.floor(foodDatabase.length * 0.02)} alimentos\n🔄 \xDAltima atualiza\xE7\xE3o: Hoje\n📋 Categorias: ${Math.floor(foodDatabase.length / 120)}\n\u2705 Validados TACO: ${Math.floor(foodDatabase.length * 0.92)}\n\u{1F195} Adicionados manual: ${Math.floor(foodDatabase.length * 0.08)}`, "info");
  } }, /* @__PURE__ */ React.createElement("div", { className: "w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4" }, /* @__PURE__ */ React.createElement(Database, { className: "text-blue-600", size: 24 })), /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold text-gray-900" }, databaseStats.totalFoods), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Alimentos Cadastrados"), /* @__PURE__ */ React.createElement("div", { className: "mt-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full" }, `+${Math.floor(foodDatabase.length * 0.02)} este m\xEAs`))), /* @__PURE__ */ React.createElement(Card, { className: "p-6 text-center hover:shadow-lg transition-shadow cursor-pointer", onClick: () => {
    showInfoPopup("👥 Clientes Totais", `Total: ${databaseStats.totalClients} clientes\n\n📊 Distribui\xE7\xE3o:\n\u2022 Ativos: ${Math.floor(mockClients.length * 0.79)} (79%)\n\u2022 Pausados: ${Math.floor(mockClients.length * 0.15)} (15%)\n\u2022 Inativos: ${Math.floor(mockClients.length * 0.06)} (6%)\n\n🎯 Objetivos mais comuns:\n\u2022 Perda de peso: 45%\n\u2022 Ganho de massa: 32%\n\u2022 Manuten\xE7\xE3o: 23%`, "info");
  } }, /* @__PURE__ */ React.createElement("div", { className: "w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4" }, /* @__PURE__ */ React.createElement(Users, { className: "text-green-600", size: 24 })), /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold text-gray-900" }, databaseStats.totalClients), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Clientes Totais"), /* @__PURE__ */ React.createElement("div", { className: "mt-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full" }, `${Math.floor(mockClients.length * 0.79)} ativos`))), /* @__PURE__ */ React.createElement(Card, { className: "p-6 text-center hover:shadow-lg transition-shadow cursor-pointer", onClick: () => {
    showInfoPopup("📋 Dietas Geradas", `Total: ${databaseStats.totalDiets} dietas\n\n\u{1F4C8} Este m\xEAs: ${dashboardStats.monthlyUsage} dietas\n\u26A1 M\xE9dia di\xE1ria: ${Math.floor(parseInt(dashboardStats.monthlyUsage) / 30)} dietas\n🎯 Tipos mais gerados:\n\u2022 IA Personalizada: 67%\n\u2022 Templates: 28%\n\u2022 Manual: 5%\n\n\u{1F3C6} Personal mais ativo:\n${currentUser?.name || 'Personal'} - ${Math.floor(parseInt(dashboardStats.monthlyUsage) * 0.23)} dietas`, "info");
  } }, /* @__PURE__ */ React.createElement("div", { className: "w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4" }, /* @__PURE__ */ React.createElement(FileText, { className: "text-orange-600", size: 24 })), /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold text-gray-900" }, databaseStats.totalDiets), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Dietas Geradas"), /* @__PURE__ */ React.createElement("div", { className: "mt-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-orange-100 text-orange-700 px-2 py-1 rounded-full" }, `${dashboardStats.monthlyUsage} este m\xEAs`))), /* @__PURE__ */ React.createElement(Card, { className: "p-6 text-center hover:shadow-lg transition-shadow cursor-pointer", onClick: () => {
    showInfoPopup("📊 Taxa de Sucesso", `Taxa atual: ${databaseStats.successRate}\n\n\u2705 M\xE9tricas:\n\u2022 Clientes satisfeitos: ${databaseStats.successRate}\n\u2022 Dietas seguidas: ${(parseFloat(databaseStats.successRate) - 6.9).toFixed(1)}%\n\u2022 Objetivos alcan\xE7ados: ${(parseFloat(databaseStats.successRate) - 2.4).toFixed(1)}%\n\u2022 Renova\xE7\xF5es: ${(parseFloat(databaseStats.successRate) - 4.8).toFixed(1)}%\n\n\u{1F4C8} Tend\xEAncia: +2.1% vs m\xEAs anterior\n🎯 Meta: 95% at\xE9 fim do ano`, "success");
  } }, /* @__PURE__ */ React.createElement("div", { className: "w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4" }, /* @__PURE__ */ React.createElement(BarChart3, { className: "text-purple-600", size: 24 })), /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold text-gray-900" }, databaseStats.successRate), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Taxa de Sucesso"), /* @__PURE__ */ React.createElement("div", { className: "mt-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-purple-100 text-purple-700 px-2 py-1 rounded-full" }, "+2.1% mensal")))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6" }, /* @__PURE__ */ React.createElement(Card, { className: "p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold text-gray-900" }, "Alimentos Mais Utilizados"), /* @__PURE__ */ React.createElement(
    Button,
    {
      size: "sm",
      variant: "outline",
